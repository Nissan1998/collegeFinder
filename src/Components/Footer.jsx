...
import footerImg from "../assets/ImageforTask/footer.jpg";
const Footer = () => {
    ...
    <div>
      ...
      >
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <p className="text-xl">Contact:+8801629880885</p>
          <p className="text-xl">Address:</p>
          <p className="text-xl">51/A/10 West Razabazar</p>
        </div>
      </footer>
      <div className="footer footer-center p-4 bg-base-content text-white">
        <p>
